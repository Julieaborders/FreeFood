...
<head>
    ...
    <title>Contact - Fresh Food Finds</title>
...
<div class="box">
                  ...
                  <div class="col-lg-12">
                    ...
                    <hr>
                    <p>You may contact us at our Midtown Atlanta offices in Tech Square Labs.</p>
                            <div class="col-md-4">
                    <p>Phone:
                        <strong>678-517-2272</strong>
                    </p>
                    <p>Email:
                        <strong><a href="mailto:FreshFoodfinds.gmail.com">freshfoodfinds@gmail.com</a></strong>
                    </p>
                    <p>Address:
                        <strong>859 Spring St., NW
                            <br>Atlanta, GA 30309</strong>
                    </p>
                </div>
                <div class="col-md-8">
